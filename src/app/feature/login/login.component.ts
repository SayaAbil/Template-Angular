...
@Component({
    ...
    imports: [ReactiveFormsModule,PasswordModule,InputTextModule,FormsModule,ButtonModule,DividerModule,CardModule,MatButtonModule]
})
export class LoginComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.action$
      .pipe(
        ofActionCompleted(AuthAction.AuthLogin),
        takeUntil(this.destroyer$)
      )
