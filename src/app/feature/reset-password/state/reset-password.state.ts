...
export class ResetPasswordState {
  ...
  @Action(ResetPasswordAction.ResetPassword, {cancelUncompleted: true})
  resetPassword(ctx: StateContext<ResetPasswordStateModel>, {username, data}: ResetPasswordAction.ResetPassword) {
